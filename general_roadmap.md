...
gantt
  ...
  section Phase 0 — Concierge Bare Metal (Validation)
  ...
  section Phase 1 — Pods MVP (Self-serve GPU VMs / Bare Metal)
  ...
  section Phase 2 — Templates + “Jobs on Pods” (Make pods useful in 1 click)
  ...
  section Phase 3 — Serverless v0 (One runtime, warm pool)
  ...
  section Phase 4 — Managed Vector DB (Dedicated-per-customer first)
